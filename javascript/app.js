...
function displayAlbumsAndTracks(event) {
  ...
  getAlbums.done(function(data) {
      var albumnData = (data.items)
      albumnData.forEach(function(album) {
        console.log(album);
        ...
        var getTracks = $.ajax({
          ...
          albumTracks.forEach(function(albumTrack) {
            console.log(albumName, albumTrack.name)
            albumLi.append(albumTrack.name)
          })
        })
      })
    })
